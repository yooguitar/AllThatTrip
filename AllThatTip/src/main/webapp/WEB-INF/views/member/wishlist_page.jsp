...
<body>
    <div id="wrap">
            ...
            <c:when test="">
                ...
                <li id="content-empty">  
                    <div class="content-div-temp">
                        <h3 style="text-align: center;">찜 내역이 없습니다.</h3>
                    </div>
                </li>
            </c:when>
            <c:otherwise>
        ...
        <div id="cart-div-3" class="cart-div">
            ...
            <br><br>
            <button onclick="" class="btn btn-primary" style="width: 250px; height: 60px; background-color:rgb(50, 96, 68); border:rgb(50, 96, 68);">선택 항목 장바구니에 담기</button>
            <br>
            <button onclick="" class="btn btn-primary" style="width: 250px; height: 60px; background-color:rgb(50, 96, 68); border:rgb(50, 96, 68); margin-top: 10px;">선택 항목 주문하기</button>
        </div>
